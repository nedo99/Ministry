...
--
-- Host: localhost
-- Generation Time: May 27, 2012 at 10:49 PM
...
(2, 'Neki', 'Ciko', '000000', '1200000000', 'neki@gmail.com', 'dfkhgdfkgh', 'kdfghjkdg', '2012-05-16', '2012-05-17', 'fdgdfg', 'dfgsdg');
...
CREATE TABLE IF NOT EXISTS `korisnici` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=ucs2 COLLATE=ucs2_slovenian_ci AUTO_INCREMENT=4 ;

--
-- Dumping data for table `korisnici`
--

INSERT INTO `korisnici` (`id`, `user`, `pass`, `tip`, `validan`, `clan_id`) VALUES
(1, 'nedim', 'ac1fbc15be73fdcf2d2a36ad2bbc2c91', 'SuperAdmin', 1, 1),
(3, 'nedo', '02cc9a8e33141105332a953073417803', 'admin', 1, 2);
...
CREATE TABLE IF NOT EXISTS `ministarstva` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `slope_one` (`id`, `clan_id`, `novost_id`, `procitao`) VALUES
(1, 1, 4, 1),
(2, 1, 3, 1),
(3, 2, 4, 1),
(4, 2, 3, 0);
